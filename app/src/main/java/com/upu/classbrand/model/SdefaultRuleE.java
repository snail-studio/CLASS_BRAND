...
public class SdefaultRuleE {
    private long day=86400000;
    private long amtimeinS;
    private long amtimeinT;

    public SdefaultRuleE(long amtimeinS, long amtimeinT, long amtimeleaveS, long amtimeleaveT, long midinS, long midinT, long midleaveS, long midleaveT, long afterinS, long afterinT, long afterleaveS, long afterleaveT,String execuTime) {
